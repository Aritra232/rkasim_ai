...
# # from .config import embeddings, KNOWLEDGE_BASE_PATH, FAISS_INDEX_PATH
...
#     """
#     Load vector store from disk if exists, otherwise create it from knowledge base documents.
    
#     Returns:
#         FAISS: The loaded or created vector store
#     """
